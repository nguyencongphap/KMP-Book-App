...
class KtorRemoteBookDataSource(
    ...
    override suspend fun getBookDetails(bookWorkId: String): Result<BookWorkDto, DataError.Remote> {
        return safeCall<BookWorkDto> { // safeCall parses the result of the httpClient.get into util Result class
            httpClient.get(
                urlString = "$BASE_URL/works/$bookWorkId.json" // example: https://openlibrary.org/works/OL1968368W.json
            )
        }
    }
